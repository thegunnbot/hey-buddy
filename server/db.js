...
export function getChampionCounts(championId) {
  const db = getDb()
...
export function seedMockData() {
  ...
  const champions = [
    {
      id: 'c1', name: 'James Mitchell', initials: 'JM', company: 'Meridian Insurance',
      ...
      personal_contact: 'null', last_contact_date: '2026-02-21', last_contact_type: 'Call',
      location_city: 'London', location_country: 'UK',
    },
    {
      id: 'c2', name: 'Sarah Clarke', initials: 'SC', company: "Pemberton Specialty",
    ...
    {
      id: 'c3', name: 'Michael Chen', initials: 'MC', company: 'Apex General Insurance',
      ...
      personal_contact: 'null', last_contact_date: '2026-02-23', last_contact_type: 'Email',
      location_city: 'London', location_country: 'UK',
    },
    {
      id: 'c4', name: 'Emma Walsh', initials: 'EW', company: 'Continental Re',
      ...
      personal_contact: 'null', last_contact_date: '2026-03-01', last_contact_type: 'Call',
      location_city: 'Continental Re', location_country: 'Switzerland',
    },
    {
      id: 'c5', name: 'David Patel', initials: 'DP', company: 'Atlas Assurance',
    ...
    {
      id: 'c6', name: 'Claire Sutton', initials: 'CS', company: 'Summit Re',
      ...
      personal_contact: 'null', last_contact_date: '2026-02-20', last_contact_type: 'Call',
      location_city: 'Continental Re', location_country: 'Switzerland',
    },
  ]
  ...
  const interactions = [
    ...
    { id: 'i3', champion_id: 'c1', date: '2025-12-10', type: 'Meeting', notes: 'In-person at Meridian HQ. First real 1-1. Got his mobile.' },
    ...
    { id: 'i5', champion_id: 'c3', date: '2026-02-23', type: 'Email', notes: "Forwarded competitor proposal (a legacy platform) unprompted. Massive signal." },
